...
public class LocalTimeModifiedExample {
    public static void main(String[] args) {
        ...
        System.out.println("localTime.plusSeconds(34) = " + localTime.plusSeconds(34));
        System.out.println("localTime.plusNanos(222222222222) = " + localTime.plusNanos(222_222_222));
