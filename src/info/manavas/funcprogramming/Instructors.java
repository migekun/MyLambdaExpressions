...
public class Instructors {
    ...
    public static List<Instructor> getAll() {
        ...
        Instructor instructor2 = new Instructor("Jenny", 15, "Engineer", "F", false, Arrays.asList("Multi-thread Programming", "CI/CD", "Unit Testing"));
        Instructor instructor3 = new Instructor("Gene", 6, "Manager", "M", true, Arrays.asList("C++ Programming", "C Programming", "React Native"));
        ...
        Instructor instructor5 = new Instructor("Syed", 5, "Principal Engineer", "M", true, Arrays.asList("Java Programming", "Java Multi-Threaded Programming", "React Native"));
